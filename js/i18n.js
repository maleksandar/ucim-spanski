...
(function (global) {
  ...
  var STRINGS = {
    sr: {
      ...
      typeWriteEs: "Upiši prevod (SRP→ŠPA)",
      typeWriteCloze: "Upiši reč u praznini",
      typeWriteConjug: "Upiši oblik glagola",
      mode: "Režim",
      ...
      next: "Dalje",
      finish: "Završi",
      typeAnswer: "Upiši odgovor…",
      checkAnswer: "Proveri",
      emptyAnswer: "Upiši nešto pa proveri.",
      accentHint: "Akcenti se pišu ovako:",
      nearMiss: "Skoro tačno — fali ti jedno slovo. Ispravi pa proveri ponovo.",
      skip: "Preskoči",
      showExample: "Primer",
      results: "Rezultat",
      score: "Poeni",
      ...
      sortAlphaEs: "Abecedno (ŠPA)",
      sortAlphaSr: "Abecedno (SRP)",
      sortLesson: "Po lekciji",
      sortTopic: "Po temi",
      sortLangLabel: "Glavna reč",
      sortLangEs: "ŠPA",
      sortLangSr: "SRP",
      sortLangHint: "Bira po kojim se rečima sortira i koja je reč glavna u kartici.",
      filterTopic: "Tema",
      ...
      typeShort: {
        ...
        "write-es": "upis ŠPA", "write-cloze": "upis praznine", "write-conjug": "upis glagola"
      },
      allTypes: "svi tipovi",
      quizColumn: "Kviz",
      menu: "Meni",
    ...
    es: {
      ...
      typeWriteEs: "Escribe la traducción (SR→ES)",
      typeWriteCloze: "Escribe la palabra que falta",
      typeWriteConjug: "Escribe la forma del verbo",
      mode: "Modo",
      ...
      emptyAnswer: "Escribe algo antes de comprobar.",
      accentHint: "Las tildes se escriben así:",
      nearMiss: "Casi — te falla una letra. Corrígela y comprueba otra vez.",
      skip: "Saltar",
      showExample: "Ejemplo",
      results: "Resultado",
      score: "Puntos",
      ...
      sortAlphaEs: "Alfabético (ES)",
      sortAlphaSr: "Alfabético (SR)",
      sortLesson: "Por clase",
      sortTopic: "Por tema",
      sortLangLabel: "Palabra principal",
      sortLangEs: "ES",
      sortLangSr: "SR",
      sortLangHint: "Elige por qué palabras se ordena y cuál es la principal en la ficha.",
      filterTopic: "Tema",
      filterPos: "Categoría",
      filterLesson: "Clase",
      all: "Todo",
      ...
      typeShort: {
        ...
        "write-es": "escribir ES", "write-cloze": "escribir hueco", "write-conjug": "escribir verbo"
      },
